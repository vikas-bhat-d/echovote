  ...
  return (
    <>
      ...
      <div className="Heading relative flex flex-col items-center text-center p-6 bg-opacity-50 bg-white rounded-lg max-w-lg md:max-w-2xl lg:max-w-4xl mx-0 h-[50%] justify-center gap-3"> 
        ...
        <Link to="/playList/:venueName"> <li className="list-none mt-8 px-4 sm:px-6 py-3 bg-[#027ED1ff] text-white font-semibold rounded-full hover:bg-blue-700 transition duration-200 text-sm sm:text-base">Get Started</li></Link>
